...
int delete_at(void **arr, int *len, int index) {
	...
	if ( ((element*)(*arr+ant_dim)) != NULL ) {
		if ( ((element*)(*arr+ant_dim))->header->type == 1 ) {
			free( ((tip1*)((element*)(*arr+ant_dim))->data)->manelist );
			free( ((tip1*)((element*)(*arr+ant_dim))->data)->pers );
			free( ((tip1*)((element*)(*arr+ant_dim))->data));
		}
		if ( ((element*)(*arr+ant_dim))->header->type == 2 ) {
			free( ((tip2*)((element*)(*arr+ant_dim))->data)->manelist );
			free( ((tip2*)((element*)(*arr+ant_dim))->data)->pers );
			free( ((tip2*)((element*)(*arr+ant_dim))->data) );
		}
		if ( ((element*)(*arr+ant_dim))->header->type == 3 ) {
			free( ((tip3*)((element*)(*arr+ant_dim))->data)->manelist );
			free( ((tip3*)((element*)(*arr+ant_dim))->data)->pers );
			free( ((tip3*)((element*)(*arr+ant_dim))->data) );
		}
	}
